...
fn ntml_create_tab_state(
    ...
    app: tauri::AppHandle,
) -> Result<NtmlCreateTabStateResult, String> {
    let md: Vec<(String, String)> = markdown_contents
        .unwrap_or_default()
        .into_iter()
        .map(|m| (m.src, m.content))
        .collect();
    let network_entries = ntml_runtime::create_tab_state(
        store.as_ref(),
        tab_id,
        base_url,
        script_sources,
    ...
    Ok(NtmlCreateTabStateResult { network_entries })
}

#[derive(serde::Serialize)]
struct NtmlCreateTabStateResult {
    network_entries: Vec<ntml_runtime::HandlerNetworkEntry>,
}
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            grpc::grpc_set_hackerboard_language_preferences,
            grpc::grpc_set_hackerboard_avatar_from_vm_path,
            grpc::grpc_set_hackerboard_faction_emblem_from_vm_path,
            grpc::grpc_create_faction,
            grpc::grpc_leave_faction,
            grpc::grpc_send_faction_invite,
            grpc::grpc_list_faction_invites,
            grpc::grpc_accept_faction_invite,
            grpc::grpc_decline_faction_invite,
            grpc::grpc_list_outgoing_faction_invites,
            grpc::grpc_cancel_faction_invite,
            grpc::grpc_kick_faction_member,
            grpc::grpc_unban_faction_member,
            grpc::grpc_list_faction_banned_members,
            grpc::grpc_block_hackerboard_player,
            grpc::grpc_unblock_hackerboard_player,
            grpc::grpc_list_blocked_players,
            grpc::grpc_list_hackerboard_dm_threads,
            grpc::grpc_list_hackerboard_dm_messages,
            grpc::grpc_send_hackerboard_dm,
            grpc::grpc_list_hackerboard_faction_messages,
            grpc::grpc_send_hackerboard_faction_message,
            grpc::grpc_list_feed_posts,
            grpc::grpc_create_feed_post,
            grpc::grpc_toggle_feed_post_like,
            ...
            grpc::grpc_write_file_bytes,
            grpc::grpc_read_file,
            grpc::grpc_read_file_base64,
