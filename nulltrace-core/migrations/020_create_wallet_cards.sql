-- Virtual credit cards issued by Fkebank (player-scoped for now).
-- billing_day_of_week = 1 means Monday (ISO weekday). All monetary fields in cents (BIGINT).
CREATE TABLE IF NOT EXISTS wallet_cards (
    ...
    billing_day_of_week INT         NOT NULL DEFAULT 1,
